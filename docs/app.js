...
(function(exports) {
  ...
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var Prelude = PS["Prelude"];        
  var DialogDSL = function (Monad0, Monad1, showDialog) {
      this.Monad0 = Monad0;
      this.Monad1 = Monad1;
  ...
  var dialogDSLHalogenM = function (dictDialogDSL) {
      ...
      }, dictDialogDSL.Monad1, function ($1) {
          return Halogen_Query_HalogenM.HalogenM(Control_Monad_Free.liftF(Halogen_Query_HalogenM.Lift.create(showDialog(dictDialogDSL)($1))));
      });
  };
...
(function(exports) {
  ...
  var navigationDSLHalogenM = function (dictNavigationDSL) {
      return new NavigationDSL(function () {
          ...
          return Halogen_Query_HalogenM.HalogenM(Control_Monad_Free.liftF(Halogen_Query_HalogenM.Lift.create(navigate(dictNavigationDSL)($1))));
      });
  };
...
(function(exports) {
  ...
  var stateDSLHalogenM = function (dictStateDSL) {
      return new StateDSL(function () {
          return Halogen_Query_HalogenM.monadHalogenM;
      }, Halogen_Query_HalogenM.HalogenM(Control_Monad_Free.liftF(Halogen_Query_HalogenM.Lift.create(getState(dictStateDSL)))), function ($3) {
          return Halogen_Query_HalogenM.HalogenM(Control_Monad_Free.liftF(Halogen_Query_HalogenM.Lift.create(modifyState(dictStateDSL)($3))));
      });
  };
...
(function(exports) {
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Example.Component.Home line 56, column 3 - line 56, column 59: " + [ v.constructor.name ]);
      };
      return Halogen_Component.lifecycleComponent(Halogen_HTML_Core.bifunctorHTML)({
          initialState: Data_Function["const"]({
              secretNumber: 0,
