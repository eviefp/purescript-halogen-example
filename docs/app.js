...
(function(exports) {
  ...
  var serverDSLExampleM = new Example_DSL_Server.ServerDSL(function () {
      return monadExampleM;
  }, Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect_Aff.bindAff))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect_Aff.monadAff)))(function (v) {
  ...
  var stateDSLExampleM = function (dictTypeEquals) {
      return new Example_DSL_State.StateDSL(function () {
          return monadExampleM;
      }, Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect_Aff.bindAff))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect_Aff.monadAff)))(function (v) {
          return Effect_Class.liftEffect(Control_Monad_Reader_Trans.monadEffectReader(Effect_Aff.monadEffectAff))(Data_Functor.map(Effect.functorEffect)(Type_Equality.from(dictTypeEquals))(Effect_Ref.read(v.state)));
      }), function (f) {
          return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect_Aff.bindAff))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect_Aff.monadAff)))(function (v) {
              return Effect_Class.liftEffect(Control_Monad_Reader_Trans.monadEffectReader(Effect_Aff.monadEffectAff))(Effect_Ref.modify_(function ($17) {
                  return Type_Equality.to(dictTypeEquals)(f(Type_Equality.from(dictTypeEquals)($17)));
              })(v.state));
          });
      });
  };                                                                                                
  var monadAskExampleM = function (dictTypeEquals) {
      return new Control_Monad_Reader_Class.MonadAsk(function () {
          return monadExampleM;
      }, ExampleM(Control_Monad_Reader_Class.asks(Control_Monad_Reader_Trans.monadAskReaderT(Effect_Aff.monadAff))(Type_Equality.from(dictTypeEquals))));
  };
...
(function(exports) {
  ...
  var component = function (dictMonadAsk) {
      return function (dictStateDSL) {
          return function (dictDialogDSL) {
              return function (dictNavigationDSL) {
                  ...
                  var $$eval = function (v) {
                      if (v instanceof Initialize) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Reader_Class.ask(Halogen_Query_HalogenM.monadAskHalogenM(dictMonadAsk)))(function (v1) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Example_DSL_State.getState(Example_DSL_State.stateDSLHalogenM(dictStateDSL)))(function (v2) {
                      ...
                      if (v instanceof ValueChanged) {
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                              ...
                              $13.secret = Data_Maybe.maybe(st.secret)(Control_Category.identity(Control_Category.categoryFn))(num);
                              return $13;
                          }))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                          });
                      ...
                      if (v instanceof UpdateValue) {
                          var updateValue = Example_DSL_State.setState(dictStateDSL);
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Example_DSL_Dialog.showDialog(Example_DSL_Dialog.dialogDSLHalogenM(dictDialogDSL))({
                                  title: "Confirmation",
                                  ...
                                  actions: [ {
                                      ...
                                      name: "Nevermind",
                                      action: Control_Applicative.pure((dictDialogDSL.Monad0()).Applicative0())(Data_Unit.unit)
                                  } ]
                              }))(function () {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                              });
                      ...
                      if (v instanceof GotoHome) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Example_DSL_Navigation.navigate(Example_DSL_Navigation.navigationDSLHalogenM(dictNavigationDSL))(Example_Component_Router_Query.Home.value))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                          });
                      };
                      throw new Error("Failed pattern match at Example.Component.Details line 72, column 3 - line 72, column 53: " + [ v.constructor.name ]);
                  };
...
(function(exports) {
  ...
  var component = function (dictStateDSL) {
      return function (dictServerDSL) {
          return function (dictNavigationDSL) {
              var render = function (st) {
                  var showSecretNumber = function (v) {
                      ...
                      throw new Error("Failed pattern match at Example.Component.Home line 60, column 5 - line 60, column 44: " + [ v.constructor.name ]);
                  };
              ...
              var $$eval = function (v) {
                  if (v instanceof Initialize) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Example_DSL_State.getState(Example_DSL_State.stateDSLHalogenM(dictStateDSL)))(function (v1) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Example_DSL_Server.getGreeting(Example_DSL_Server.serverDSLHalogenM(dictServerDSL)))(function (v2) {
                  ...
                  if (v instanceof GotoDetails) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Example_DSL_Navigation.navigate(Example_DSL_Navigation.navigationDSLHalogenM(dictNavigationDSL))(Example_Component_Router_Query.Details.value))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                      });
                  };
                  throw new Error("Failed pattern match at Example.Component.Home line 66, column 3 - line 66, column 53: " + [ v.constructor.name ]);
              };
              return Halogen_Component.lifecycleComponent(Halogen_HTML_Core.bifunctorHTML)({
                  initialState: Data_Function["const"]({
                          ...
                          var render = function (v) {
                              var renderRoute = function (v1) {
                                  if (v1 instanceof Example_Component_Router_Query.Home) {
                                      return Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(Example_Component_Home.component(dictStateDSL)(dictServerDSL)(dictNavigationDSL))(Data_Unit.unit)(Data_Void.absurd);
                                  };
                                  if (v1 instanceof Example_Component_Router_Query.Details) {
                                      return Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp3)(Data_Unit.unit)(Example_Component_Details.component(dictMonadAsk)(dictStateDSL)(dictDialogDSL)(dictNavigationDSL))(Data_Unit.unit)(Data_Void.absurd);
                                  };
                                  throw new Error("Failed pattern match at Example.Component.Router line 70, column 19 - line 72, column 68: " + [ v1.constructor.name ]);
                              };
                              ...
                              var renderDialog = function (v1) {
                                  ...
                                  throw new Error("Failed pattern match at Example.Component.Router line 74, column 5 - line 74, column 89: " + [ v1.constructor.name ]);
                              };
                          ...
                          var $$eval = function (v) {
                              if (v instanceof Example_Component_Router_Query.ShowDialog) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                                      ...
                                      $21.dialogOptions = new Data_Maybe.Just(v.value0);
                                      return $21;
                                  }))(function () {
                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                                  });
                                          ...
                                          if (v1.dialogOptions instanceof Data_Maybe.Just) {
                                              ...
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                                  ...
                                                  if (maybeAction instanceof Data_Maybe.Just) {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(maybeAction.value0.action))(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                                              ...
                                                              $29.dialogOptions = Data_Maybe.Nothing.value;
                                                              return $29;
                                                          }))(function () {
                                                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                                                          });
                                                  ...
                                                  throw new Error("Failed pattern match at Example.Component.Router line 96, column 9 - line 101, column 22: " + [ maybeAction.constructor.name ]);
                                              })())(function () {
                                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                                              });
                                          };
                                          throw new Error("Failed pattern match at Example.Component.Router line 92, column 5 - line 102, column 18: " + [ v1.dialogOptions.constructor.name ]);
                                      })())(function () {
                                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                                      });
                                  });
                              ...
                              throw new Error("Failed pattern match at Example.Component.Router line 86, column 3 - line 86, column 69: " + [ v.constructor.name ]);
                          };
      ...
      return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref["new"](0)))(function (v1) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(FRP_Event.create))(function (v2) {
                  ...
                  var router$prime = Halogen_Component.hoist(Halogen_HTML_Core.bifunctorHTML)(Effect_Aff.functorAff)(Data_Function.flip(Example_Control_Monad.runExampleM)(environment))(Example_Component_Router.component(Example_Control_Monad.monadAskExampleM(Type_Equality.refl))(Example_Control_Monad.stateDSLExampleM(Type_Equality.refl))(Example_Control_Monad.serverDSLExampleM)(Example_Control_Monad.dialogDSLExampleM)(Example_Control_Monad.navigationDSLExampleM)(Example_Control_Monad.monadAffExampleM));
