...
(function(exports) {
  ...
  var showDialog = function ($44) {
      return Run.lift()(new Data_Symbol.IsSymbol(function () {
          return "showDialog";
      }))(functorShowDialogF)(_showDialog)(Data_Function.flip(ShowDialogF.create)(Data_Unit.unit)($44));
  };
  ...
  var navigate = function ($45) {
      return Run.lift()(new Data_Symbol.IsSymbol(function () {
          return "navigate";
      }))(functorNavigateF)(_navigate)(Data_Function.flip(NavigateF.create)(Data_Unit.unit)($45));
  };
          ...
          return function (push) {
              return function (token) {
                  ...
                  var runOptions = function (d) {
                      var $26 = {};
                      for (var $27 in d) {
                          if ({}.hasOwnProperty.call(d, $27)) {
                              $26[$27] = d[$27];
                          };
                      };
                      $26.actions = Data_Functor.map(Data_Functor.functorArray)(runAction)(d.actions);
                      return $26;
                  };
                  var runAction = function (a) {
                      var $29 = {};
                      for (var $30 in a) {
                          if ({}.hasOwnProperty.call(a, $30)) {
                              $29[$30] = a[$30];
                          };
                      };
                      $29.action = Run.runRec(Control_Monad_Aff.monadRecAff)(go)(Run.expand()(a.action));
                      return $29;
                  };
                  var go = Data_Functor_Variant.on()(new Data_Symbol.IsSymbol(function () {
                      return "showDialog";
                  }))(_showDialog)(function (v) {
                      ...
                      return "state";
                  }))(Data_Symbol.SProxy.value)(function (v) {
