...
(function(exports) {
  ...
  var _reader = Data_Symbol.SProxy.value;
  var liftReader = Run.lift()(new Data_Symbol.IsSymbol(function () {
      return "reader";
  }))(functorReader)(_reader);
  var ask = liftReader(Control_Category.id(Control_Category.categoryFn));
  exports["_reader"] = _reader;
  exports["liftReader"] = liftReader;
  exports["ask"] = ask;
  exports["functorReader"] = functorReader;
})(PS["Run.Reader"] = PS["Run.Reader"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var liftState = Run.lift()(new Data_Symbol.IsSymbol(function () {
      return "state";
  }))(functorState)(_state);
  var get = liftState(new State(Control_Category.id(Control_Category.categoryFn), Control_Category.id(Control_Category.categoryFn)));
  var modify = function (f) {
      return liftState(new State(f, Data_Function["const"](Data_Unit.unit)));
  };
  var put = function ($17) {
      return modify(Data_Function["const"]($17));
  };
  exports["State"] = State;
...
(function(exports) {
  ...
  var ShowDialogF = (function () {
      ...
      ShowDialogF.create = function (value0) {
          return function (value1) {
              return new ShowDialogF(value0, value1);
          };
      };
      return ShowDialogF;
  })();
  ...
  var ServerF = (function () {
      ...
      ServerF.create = function (value0) {
          return new ServerF(value0);
      };
      return ServerF;
  })();
  ...
  var NavigateF = (function () {
      ...
      NavigateF.create = function (value0) {
          return function (value1) {
              return new NavigateF(value0, value1);
          };
      };
      return NavigateF;
  })();
  var runState = function (state) {
      return function (v) {
          var fix = function (s2a) {
              return function (s2s) {
                  return function (s) {
                      return {
                          state: s2s(s),
          ...
          return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref["modifyRef'"](state)(fix(v.value1)(v.value0)));
      };
  };
  var runServer = function (token) {
      return function (v) {
          return v.value0(token);
      };
  };
  var runReader = function (env) {
      return function (v) {
          return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(v(env));
      };
  };
  var runNavigate = function (push) {
      return function (v) {
          return Data_Functor.voidRight(Control_Monad_Aff.functorAff)(v.value1)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(push(PushRoute.create(v.value0))));
      };
  };
  var runDialog = function (trans) {
      return function (push) {
          return function (v) {
              var runAction = function (a1) {
                  var $34 = {};
                  for (var $35 in a1) {
                      if ({}.hasOwnProperty.call(a1, $35)) {
                          $34[$35] = a1[$35];
                      };
                  };
                  $34.action = Run.runRec(Control_Monad_Aff.monadRecAff)(trans)(a1.action);
                  return $34;
              };
              var runOptions = function (d) {
                  var $37 = {};
                  for (var $38 in d) {
                      if ({}.hasOwnProperty.call(d, $38)) {
                          $37[$38] = d[$38];
                      };
                  };
                  $37.actions = Data_Functor.map(Data_Functor.functorArray)(runAction)(d.actions);
                  return $37;
              };
  ...
  var functorShowDialogF = new Data_Functor.Functor(function (f) {
      return function (m) {
          return new ShowDialogF(m.value0, f(m.value1));
      };
  });
  var functorServerF = new Data_Functor.Functor(function (f) {
      return function (m) {
          return new ServerF(Data_Functor.map(Data_Functor.functorFn)(Data_Functor.map(Control_Monad_Aff.functorAff)(f))(m.value0));
      };
  });
  var functorNavigateF = new Data_Functor.Functor(function (f) {
      return function (m) {
          return new NavigateF(m.value0, f(m.value1));
      };
  });
  var _state = Data_Symbol.SProxy.value;
  var _showDialog = Data_Symbol.SProxy.value;
  var showDialog = function ($50) {
      return Run.lift()(new Data_Symbol.IsSymbol(function () {
          return "showDialog";
      }))(functorShowDialogF)(_showDialog)(Data_Function.flip(ShowDialogF.create)(Data_Unit.unit)($50));
  };
  var _server = Data_Symbol.SProxy.value;
  var getGreeting = Run.lift()(new Data_Symbol.IsSymbol(function () {
      return "server";
  }))(functorServerF)(_server)(ServerF.create(Example_Server_ServerAPI.getGreetingImpl));
  var _reader = Data_Symbol.SProxy.value;
  var _navigate = Data_Symbol.SProxy.value;
  var navigate = function ($51) {
      return Run.lift()(new Data_Symbol.IsSymbol(function () {
          return "navigate";
      }))(functorNavigateF)(_navigate)(Data_Function.flip(NavigateF.create)(Data_Unit.unit)($51));
  };

  //--------------------------------------------------------------------
  // Stuff
  //--------------------------------------------------------------------
  var _aff = Data_Symbol.SProxy.value;
              ...
              return function (token) {
                  var go = (function () {
                      var go$prime = function (v) {
                          return go(Data_Functor_Variant.expand()(v));
                      };
                      return Data_Functor_Variant.on()(new Data_Symbol.IsSymbol(function () {
                          return "showDialog";
                      }))(_showDialog)(runDialog(go$prime)(push))(Data_Functor_Variant.on()(new Data_Symbol.IsSymbol(function () {
                          return "server";
                      }))(_server)(runServer(token))(Data_Functor_Variant.on()(new Data_Symbol.IsSymbol(function () {
                          return "state";
                      }))(_state)(runState(state))(Data_Functor_Variant.on()(new Data_Symbol.IsSymbol(function () {
                          return "navigate";
                      }))(_navigate)(runNavigate(push))(Data_Functor_Variant.on()(new Data_Symbol.IsSymbol(function () {
                          return "reader";
                      }))(_reader)(runReader(env))(Data_Functor_Variant.on()(new Data_Symbol.IsSymbol(function () {
                          return "aff";
                      }))(_aff)(Control_Category.id(Control_Category.categoryFn))(Data_Functor_Variant.case_))))));
                  })();
                  return Run.runRec(Control_Monad_Aff.monadRecAff)(go);
              };
          };
      };
  };
  exports["NavigateF"] = NavigateF;
  exports["_navigate"] = _navigate;
  exports["navigate"] = navigate;
  exports["runNavigate"] = runNavigate;
  exports["ServerF"] = ServerF;
  exports["_server"] = _server;
  exports["getGreeting"] = getGreeting;
  exports["runServer"] = runServer;
  exports["ShowDialogF"] = ShowDialogF;
  ...
  exports["functorNavigateF"] = functorNavigateF;
  exports["functorServerF"] = functorServerF;
  exports["functorShowDialogF"] = functorShowDialogF;
})(PS["Example.Control.MonadRun"] = PS["Example.Control.MonadRun"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var Data_Unit = PS["Data.Unit"];
  var Example_Component_Router_Query = PS["Example.Component.Router.Query"];
  var Example_Control_MonadRun = PS["Example.Control.MonadRun"];
  var Halogen = PS["Halogen"];
  var Halogen_Component = PS["Halogen.Component"];
  var Halogen_HTML = PS["Halogen.HTML"];
  var Halogen_HTML_Core = PS["Halogen.HTML.Core"];
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          if (v instanceof Initialize) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(Run.monadRun)(Run_Reader.ask))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(Run.monadRun)(Run_State.get))(function (v2) {
          ...
          if (v instanceof UpdateValue) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(Run.monadRun)(Example_Control_MonadRun.showDialog({
                      title: "Confirmation",
                      message: "Are you sure you want to update the value?",
                      actions: [ {
                          name: "Yes",
                          action: Run_State.put(v1.secret)
                      }, {
                          name: "Nevermind",
                          action: Control_Applicative.pure(Run.applicativeRun)(Data_Unit.unit)
                      } ]
                  })))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
          ...
          if (v instanceof GotoHome) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(Run.monadRun)(Example_Control_MonadRun.navigate(Example_Component_Router_Query.Home.value)))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          throw new Error("Failed pattern match at Example.Component.Details line 65, column 3 - line 65, column 59: " + [ v.constructor.name ]);
      };
  ...
  var component = (function () {
      var render = function (st) {
          var showSecretNumber = function (v) {
              ...
              throw new Error("Failed pattern match at Example.Component.Home line 55, column 5 - line 55, column 44: " + [ v.constructor.name ]);
          };
      ...
      var $$eval = function (v) {
          if (v instanceof Initialize) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(Run.monadRun)(Run_State.get))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(Run.monadRun)(Example_Control_MonadRun.getGreeting))(function (v2) {
          ...
          if (v instanceof GotoDetails) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(Run.monadRun)(Example_Control_MonadRun.navigate(Example_Component_Router_Query.Details.value)))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          throw new Error("Failed pattern match at Example.Component.Home line 61, column 3 - line 61, column 59: " + [ v.constructor.name ]);
      };
      return Halogen_Component.lifecycleComponent(Halogen_HTML_Core.bifunctorHTML)({
          initialState: Data_Function["const"]({
  ...
  var main = (function () {
      var handler = function (driver) {
          return function (pt) {
              return function __do() {
                  (function () {
                      if (pt instanceof Example_Control_MonadRun.PushRoute) {
                          return function __do() {
                      ...
                      if (pt instanceof Example_Control_MonadRun.PushShowDialog) {
                          return function __do() {
      ...
      return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.newRef(0)))(function (v1) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(FRP_Event.create))(function (v2) {
                  ...
                  var router$prime = Halogen_Component.hoist(Halogen_HTML_Core.bifunctorHTML)(Control_Monad_Aff.functorAff)(Example_Control_MonadRun.runExample(42)(v1)(v2.push)(token))(Example_Component_Router.component);
