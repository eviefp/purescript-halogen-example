...
(function(exports) {
  ...
  var CloseDialog = (function () {
      function CloseDialog(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      CloseDialog.create = function (value0) {
          return function (value1) {
              return new CloseDialog(value0, value1);
          };
      };
      return CloseDialog;
  })();
  var DialogResult = (function () {
      function DialogResult(value0) {
          this.value0 = value0;
      };
      DialogResult.create = function (value0) {
          return new DialogResult(value0);
      };
      return DialogResult;
  })();
  var component = (function () {
      var render = function (dialogOptions) {
          var renderAction = function (i) {
              return function (a) {
                  return Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(CloseDialog.create(i))), Halogen_HTML_Properties.class_("ps-btn") ])([ Halogen_HTML_Core.text(a) ]) ]);
              };
          };
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("ps-modal") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("guts") ])([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text(dialogOptions.title) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(dialogOptions.message) ]), Halogen_HTML_Elements.ul_(Data_Array.mapWithIndex(renderAction)(dialogOptions.actions)) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("ps-modal-overlay") ])([  ]) ]);
      };
      var $$eval = function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(DialogResult.create(v.value0)))(function () {
...
})(PS["Example.Component.Dialog"] = PS["Example.Component.Dialog"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Monad_Trans_Class = PS["Control.Monad.Trans.Class"];
  ...
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var Prelude = PS["Prelude"];                 
  var DialogDSL = function (Monad0, showDialog) {
      this.Monad0 = Monad0;
      this.showDialog = showDialog;
  };
  var showDialog = function (dict) {
      return dict.showDialog;
  };
  var dialogDSLHalogenM = function (dictDialogDSL) {
      return new DialogDSL(function () {
          return Halogen_Query_HalogenM.monadHalogenM;
      }, function ($1) {
          return Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(dictDialogDSL.Monad0())(showDialog(dictDialogDSL)($1));
      });
  };
  exports["DialogDSL"] = DialogDSL;
  exports["showDialog"] = showDialog;
  exports["dialogDSLHalogenM"] = dialogDSLHalogenM;
})(PS["Example.DSL.Dialog"] = PS["Example.DSL.Dialog"] || {});
(function(exports) {
    "use strict";
  var Data_Eq = PS["Data.Eq"];
  var Data_Ord = PS["Data.Ord"];
  var Data_Ordering = PS["Data.Ordering"];
  var Effect_Aff = PS["Effect.Aff"];
  var Example_Component_Dialog = PS["Example.Component.Dialog"];
  var Example_DSL_Dialog = PS["Example.DSL.Dialog"];
  var Prelude = PS["Prelude"];                 
  var Home = (function () {
      function Home() {
  ...
  var ShowDialog = (function () {
      function ShowDialog(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ShowDialog.create = function (value0) {
          return function (value1) {
              return new ShowDialog(value0, value1);
          };
      };
      return ShowDialog;
  })();
  var HandleDialogResult = (function () {
      function HandleDialogResult(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      HandleDialogResult.create = function (value0) {
          return function (value1) {
              return new HandleDialogResult(value0, value1);
          };
      };
      return HandleDialogResult;
  })();
  exports["Home"] = Home;
  exports["Details"] = Details;
  exports["Goto"] = Goto;
  exports["ShowDialog"] = ShowDialog;
  exports["HandleDialogResult"] = HandleDialogResult;
})(PS["Example.Component.Router.Query"] = PS["Example.Component.Router.Query"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Monad_Trans_Class = PS["Control.Monad.Trans.Class"];
  ...
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var Prelude = PS["Prelude"];                 
  var NavigationDSL = function (Monad0, navigate) {
      this.Monad0 = Monad0;
  ...
  var navigationDSLHalogenM = function (dictNavigationDSL) {
      return new NavigationDSL(function () {
          return Halogen_Query_HalogenM.monadHalogenM;
      }, function ($1) {
          return Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(dictNavigationDSL.Monad0())(navigate(dictNavigationDSL)($1));
      });
  };
  exports["NavigationDSL"] = NavigationDSL;
  exports["navigate"] = navigate;
  exports["navigationDSLHalogenM"] = navigationDSLHalogenM;
})(PS["Example.DSL.Navigation"] = PS["Example.DSL.Navigation"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Monad_Trans_Class = PS["Control.Monad.Trans.Class"];
  ...
  var serverDSLHalogenM = function (dictServerDSL) {
      return new ServerDSL(function () {
          return Halogen_Query_HalogenM.monadHalogenM;
      }, Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(dictServerDSL.Monad0())(getGreeting(dictServerDSL)));
  };
...
(function(exports) {
  ...
  var StateDSL = function (Monad0, getState, modifyState) {
      this.Monad0 = Monad0;
      this.getState = getState;
      this.modifyState = modifyState;
  };
  var modifyState = function (dict) {
      return dict.modifyState;
  };

  // | We define a helper function for setting the state when we don't care about the current state.
  var setState = function (dictStateDSL) {
      return function ($2) {
          return modifyState(dictStateDSL)(Data_Function["const"]($2));
      };
  };
  var getState = function (dict) {
      return dict.getState;
  };

  // | We need a HalogenM instance in order to be able to use this DSL
  // | within our component's `eval`.
  var stateDSLHalogenM = function (dictStateDSL) {
      return new StateDSL(function () {
          return Halogen_Query_HalogenM.monadHalogenM;
      }, Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(dictStateDSL.Monad0())(getState(dictStateDSL)), function ($3) {
          return Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(dictStateDSL.Monad0())(modifyState(dictStateDSL)($3));
      });
  };
  exports["StateDSL"] = StateDSL;
  exports["getState"] = getState;
  exports["modifyState"] = modifyState;
  exports["setState"] = setState;
  exports["stateDSLHalogenM"] = stateDSLHalogenM;
})(PS["Example.DSL.State"] = PS["Example.DSL.State"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var getGreetingImpl = function (v) {
      if (v.value0 === secretKey) {
          return Control_Applicative.pure(Effect_Aff.applicativeAff)(Control_Applicative.pure(Data_Either.applicativeEither)("hello world"));
      };
      if (Data_Boolean.otherwise) {
          return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Either.Left.create("error"));
      };
      throw new Error("Failed pattern match at Example.Server.ServerAPI line 21, column 1 - line 21, column 58: " + [ v.constructor.name ]);
  };
  exports["getGreetingImpl"] = getGreetingImpl;
...
(function(exports) {
  ...
  var PushRoute = (function () {
      function PushRoute(value0) {
          this.value0 = value0;
      };
      PushRoute.create = function (value0) {
          return new PushRoute(value0);
      };
      return PushRoute;
  })();
  var PushShowDialog = (function () {
      function PushShowDialog(value0) {
          this.value0 = value0;
      };
      PushShowDialog.create = function (value0) {
          return new PushShowDialog(value0);
      };
      return PushShowDialog;
  })();
  var GlobalState = function (x) {
      return x;
  };
  ...
  var newtypeState = new Data_Newtype.Newtype(function (n) {
      return n;
  }, GlobalState);
  var newtypeExampleM = new Data_Newtype.Newtype(function (n) {
      return n;
  }, ExampleM);
  var runExampleM = function (m) {
      return function (env) {
          return Control_Monad_Reader_Trans.runReaderT(Data_Newtype.unwrap(newtypeExampleM)(m))(env);
      };
  };
  var newtypeEnvironment = new Data_Newtype.Newtype(function (n) {
      return n;
  }, Environment);
  var monadExampleM = Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff);
  var navigationDSLExampleM = new Example_DSL_Navigation.NavigationDSL(function () {
      return monadExampleM;
  }, function (route) {
      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect_Aff.bindAff))(Data_Functor.map(Control_Monad_Reader_Trans.functorReaderT(Effect_Aff.functorAff))(Data_Newtype.unwrap(newtypeEnvironment))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect_Aff.monadAff))))(function (v) {
          return Effect_Class.liftEffect(Control_Monad_Reader_Trans.monadEffectReader(Effect_Aff.monadEffectAff))(v.push(new PushRoute(route)));
      });
  });
  var serverDSLExampleM = new Example_DSL_Server.ServerDSL(function () {
      return monadExampleM;
  }, Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect_Aff.bindAff))(Data_Functor.map(Control_Monad_Reader_Trans.functorReaderT(Effect_Aff.functorAff))(Data_Newtype.unwrap(newtypeEnvironment))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect_Aff.monadAff))))(function (v) {
      return Effect_Aff_Class.liftAff(Effect_Aff_Class.monadAffReader(Effect_Aff_Class.monadAffAff))(Example_Server_ServerAPI.getGreetingImpl(v.token));
  }));
  var stateDSLExampleM = new Example_DSL_State.StateDSL(function () {
      return monadExampleM;
  }, Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect_Aff.bindAff))(Data_Functor.map(Control_Monad_Reader_Trans.functorReaderT(Effect_Aff.functorAff))(Data_Newtype.unwrap(newtypeEnvironment))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect_Aff.monadAff))))(function (v) {
      return Effect_Class.liftEffect(Control_Monad_Reader_Trans.monadEffectReader(Effect_Aff.monadEffectAff))(Effect_Ref.read(v.state));
  }), function (f) {
      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect_Aff.bindAff))(Data_Functor.map(Control_Monad_Reader_Trans.functorReaderT(Effect_Aff.functorAff))(Data_Newtype.unwrap(newtypeEnvironment))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect_Aff.monadAff))))(function (v) {
          return Effect_Class.liftEffect(Control_Monad_Reader_Trans.monadEffectReader(Effect_Aff.monadEffectAff))(Effect_Ref.modify_(f)(v.state));
      });
  });                                                                                               
  var monadAskExampleM = Control_Monad_Reader_Trans.monadAskReaderT(Effect_Aff.monadAff);
  var monadAffExampleM = Effect_Aff_Class.monadAffReader(Effect_Aff_Class.monadAffAff);  
  var dialogDSLExampleM = new Example_DSL_Dialog.DialogDSL(function () {
      return monadExampleM;
  }, function (opts) {
      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect_Aff.bindAff))(Data_Functor.map(Control_Monad_Reader_Trans.functorReaderT(Effect_Aff.functorAff))(Data_Newtype.unwrap(newtypeEnvironment))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect_Aff.monadAff))))(function (v) {
          var runAction = function (a) {
              return {
                  name: a.name,
                  action: runExampleM(a.action)(v)
              };
          };
          var runOptions = function (d) {
              return {
                  title: d.title,
                  message: d.message,
                  actions: Data_Functor.map(Data_Functor.functorArray)(runAction)(d.actions)
              };
          };
          return Effect_Class.liftEffect(Control_Monad_Reader_Trans.monadEffectReader(Effect_Aff.monadEffectAff))(v.push(PushShowDialog.create(runOptions(opts))));
      });
  });                                                                              
  var applicativeExampleM = Control_Monad_Reader_Trans.applicativeReaderT(Effect_Aff.applicativeAff);
  exports["Environment"] = Environment;
  exports["GlobalState"] = GlobalState;
  exports["ExampleM"] = ExampleM;
  exports["runExampleM"] = runExampleM;
  exports["PushRoute"] = PushRoute;
  exports["PushShowDialog"] = PushShowDialog;
  exports["newtypeEnvironment"] = newtypeEnvironment;
  exports["newtypeState"] = newtypeState;
  exports["newtypeExampleM"] = newtypeExampleM;
  exports["applicativeExampleM"] = applicativeExampleM;
  exports["monadExampleM"] = monadExampleM;
  exports["monadAffExampleM"] = monadAffExampleM;
  exports["monadAskExampleM"] = monadAskExampleM;
  exports["navigationDSLExampleM"] = navigationDSLExampleM;
  exports["stateDSLExampleM"] = stateDSLExampleM;
  exports["serverDSLExampleM"] = serverDSLExampleM;
  exports["dialogDSLExampleM"] = dialogDSLExampleM;
...
(function(exports) {
  ...
  var ValueChanged = (function () {
      function ValueChanged(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ValueChanged.create = function (value0) {
          return function (value1) {
              return new ValueChanged(value0, value1);
          };
      };
      return ValueChanged;
  })();
  ...
  var GotoHome = (function () {
      function GotoHome(value0) {
          this.value0 = value0;
      };
      GotoHome.create = function (value0) {
          return new GotoHome(value0);
      };
      return GotoHome;
  })();
  var component = (function () {
      var render = function (st) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("The answer is " + Data_Show.show(Data_Show.showInt)(st.answer)) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Change secret number: "), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputNumber.value), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showInt)(st.secret)), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(ValueChanged.create)) ]) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(UpdateValue.create)) ])([ Halogen_HTML_Core.text("Update") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(GotoHome.create)) ])([ Halogen_HTML_Core.text("Go to home") ]) ]);
      };
      var $$eval = function (v) {
          if (v instanceof Initialize) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(Data_Newtype.unwrap(Example_Control_Monad.newtypeEnvironment))(Control_Monad_Reader_Class.ask(Halogen_Query_HalogenM.monadAskHalogenM(Example_Control_Monad.monadAskExampleM))))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Example_DSL_State.getState(Example_DSL_State.stateDSLHalogenM(Example_Control_Monad.stateDSLExampleM)))(function (v2) {
          ...
          if (v instanceof ValueChanged) {
              var num = Data_Int.fromString(v.value0);
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  ...
                  $9.secret = Data_Maybe.maybe(st.secret)(Control_Category.identity(Control_Category.categoryFn))(num);
                  return $9;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          ...
          if (v instanceof UpdateValue) {
              var updateValue = function ($17) {
                  return Example_DSL_State.setState(Example_Control_Monad.stateDSLExampleM)(Example_Control_Monad.GlobalState($17));
              };
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Example_DSL_Dialog.showDialog(Example_DSL_Dialog.dialogDSLHalogenM(Example_Control_Monad.dialogDSLExampleM))({
                      title: "Confirmation",
                      message: "Are you sure you want to update the value?",
                      actions: [ {
                          name: "Yes",
                          action: updateValue(v1.secret)
                      }, {
                          name: "Nevermind",
                          action: Control_Applicative.pure(Example_Control_Monad.applicativeExampleM)(Data_Unit.unit)
                      } ]
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
          ...
          if (v instanceof GotoHome) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Example_DSL_Navigation.navigate(Example_DSL_Navigation.navigationDSLHalogenM(Example_Control_Monad.navigationDSLExampleM))(Example_Component_Router_Query.Home.value))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          throw new Error("Failed pattern match at Example.Component.Details line 67, column 3 - line 67, column 60: " + [ v.constructor.name ]);
      };
...
})(PS["Example.Component.Details"] = PS["Example.Component.Details"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var GotoDetails = (function () {
      function GotoDetails(value0) {
          this.value0 = value0;
      };
      GotoDetails.create = function (value0) {
          return new GotoDetails(value0);
      };
      return GotoDetails;
  })();
  var component = (function () {
      var render = function (st) {
          var showSecretNumber = function (v) {
              if (v instanceof Data_Maybe.Nothing) {
              ...
              throw new Error("Failed pattern match at Example.Component.Home line 57, column 5 - line 57, column 44: " + [ v.constructor.name ]);
          };
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text(st.greeting) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text(showSecretNumber(st.secretNumber)) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(GotoDetails.create)) ])([ Halogen_HTML_Core.text("Go to details") ]) ]);
      };
      var $$eval = function (v) {
          if (v instanceof Initialize) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(Data_Newtype.unwrap(Example_Control_Monad.newtypeState))(Example_DSL_State.getState(Example_DSL_State.stateDSLHalogenM(Example_Control_Monad.stateDSLExampleM))))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Example_DSL_Server.getGreeting(Example_DSL_Server.serverDSLHalogenM(Example_Control_Monad.serverDSLExampleM)))(function (v2) {
                      var greeting = Data_Either.either(Data_Function["const"]("error"))(Control_Category.identity(Control_Category.categoryFn))(v2);
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)({
                          secretNumber: new Data_Maybe.Just(v1),
                          greeting: greeting
                      }))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                      });
          ...
          if (v instanceof GotoDetails) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Example_DSL_Navigation.navigate(Example_DSL_Navigation.navigationDSLHalogenM(Example_Control_Monad.navigationDSLExampleM))(Example_Component_Router_Query.Details.value))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          throw new Error("Failed pattern match at Example.Component.Home line 63, column 3 - line 63, column 60: " + [ v.constructor.name ]);
      };
      return Halogen_Component.lifecycleComponent(Halogen_HTML_Core.bifunctorHTML)({
          initialState: Data_Function["const"]({
              secretNumber: Data_Maybe.Nothing.value,
              greeting: ""
          }),
          render: render,
          "eval": $$eval,
...
(function(exports) {
  ...
  var Effect_Aff = PS["Effect.Aff"];
  var Effect_Aff_Class = PS["Effect.Aff.Class"];
  var Example_Component_Details = PS["Example.Component.Details"];
  var Example_Component_Dialog = PS["Example.Component.Dialog"];
  var Example_Component_Home = PS["Example.Component.Home"];
  var Example_Component_Router_Query = PS["Example.Component.Router.Query"];
  var Example_Control_Monad = PS["Example.Control.Monad"];
  var Example_DSL_Dialog = PS["Example.DSL.Dialog"];
  var Halogen = PS["Halogen"];
  ...
  var component = (function () {
      var render = function (v) {
          var renderRoute = function (v1) {
              if (v1 instanceof Example_Component_Router_Query.Home) {
                  return Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(Example_Component_Home.component)(Data_Unit.unit)(Data_Void.absurd);
              };
              ...
              throw new Error("Failed pattern match at Example.Component.Router line 58, column 19 - line 60, column 68: " + [ v1.constructor.name ]);
          };
          var getAction = function (ao) {
              return ao.name;
          };
          var shred = function (opts) {
              return {
                  title: opts.title,
                  message: opts.message,
                  actions: Data_Functor.map(Data_Functor.functorArray)(getAction)(opts.actions)
              };
          };
          var renderDialog = function (v1) {
              if (v1 instanceof Data_Maybe.Nothing) {
              ...
              throw new Error("Failed pattern match at Example.Component.Router line 62, column 5 - line 62, column 96: " + [ v1.constructor.name ]);
          };
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof Example_Component_Router_Query.HandleDialogResult) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      if (v1.dialogOptions instanceof Data_Maybe.Nothing) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                      };
                      if (v1.dialogOptions instanceof Data_Maybe.Just) {
                          var maybeAction = Data_Array.index(v1.dialogOptions.value0.actions)(v.value0.value0);
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                              if (maybeAction instanceof Data_Maybe.Nothing) {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                              };
                              if (maybeAction instanceof Data_Maybe.Just) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Example_Control_Monad.monadAffExampleM))(maybeAction.value0.action))(function () {
                              ...
                              throw new Error("Failed pattern match at Example.Component.Router line 82, column 9 - line 87, column 22: " + [ maybeAction.constructor.name ]);
                          })())(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                          });
                      };
                      throw new Error("Failed pattern match at Example.Component.Router line 78, column 5 - line 88, column 18: " + [ v1.dialogOptions.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              });
          ...
          throw new Error("Failed pattern match at Example.Component.Router line 72, column 3 - line 72, column 76: " + [ v.constructor.name ]);
      };
      return Halogen_Component.parentComponent(Data_Either.ordEither(Data_Ord.ordUnit)(Data_Either.ordEither(Data_Ord.ordUnit)(Data_Either.ordEither(Data_Ord.ordUnit)(Data_Ord.ordVoid))))({
          initialState: Data_Function["const"]({
              route: Example_Component_Router_Query.Home.value,
              dialogOptions: Data_Maybe.Nothing.value
          }),
          render: render,
          "eval": $$eval,
          receiver: Data_Function["const"](Data_Maybe.Nothing.value)
  ...
  exports["component"] = component;
})(PS["Example.Component.Router"] = PS["Example.Component.Router"] || {});
(function(exports) {
    "use strict";
...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];                 
  var main = (function () {
      var handler = function (driver) {
          return function (pt) {
              if (pt instanceof Example_Control_Monad.PushRoute) {
                  return function __do() {
                      var v = Effect_Aff.launchAff(driver.query(Halogen_Query.action(Example_Component_Router_Query.Goto.create(pt.value0))))();
                      return Data_Unit.unit;
                  };
              };
              if (pt instanceof Example_Control_Monad.PushShowDialog) {
                  return function __do() {
                      var v = Effect_Aff.launchAff(driver.query(Halogen_Query.action(Example_Component_Router_Query.ShowDialog.create(pt.value0))))();
                      return Data_Unit.unit;
                  };
              };
              throw new Error("Failed pattern match at Main line 56, column 5 - line 62, column 14: " + [ pt.constructor.name ]);
          };
      };
      return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref["new"](0)))(function (v1) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(FRP_Event.create))(function (v2) {
                  var environment = {
                      token: new Example_Server_ServerAPI.APIToken(Example_Server_ServerAPI.secretKey),
                      answer: 42,
                      state: v1,
                      push: v2.push
                  };
                  var router$prime = Halogen_Component.hoist(Halogen_HTML_Core.bifunctorHTML)(Effect_Aff.functorAff)(Data_Function.flip(Example_Control_Monad.runExampleM)(environment))(Example_Component_Router.component);
                  return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(router$prime)(Data_Unit.unit)(v))(function (v3) {
                      return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(FRP_Event.subscribe(v2.event)(handler(v3)));
                  });
              });
          });
      }));
