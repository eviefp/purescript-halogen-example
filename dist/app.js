...
(function(exports) {
  ...
  var runExample = function (env) {
      return function (push) {
          var go = function (v) {
              ...
              throw new Error("Failed pattern match at Example.Control.Monad line 64, column 9 - line 69, column 19: " + [ v.constructor.name ]);
          };
          return function ($7) {
              return Control_Monad_Free.foldFree(Control_Monad_Aff.monadRecAff)(go)(unExampleM($7));
          };
      };
  };
  ...
  var navigationDSLAlerterM = new Example_DSL_Navigation.NavigationDSL(function () {
      ...
      return ExampleM(Control_Monad_Free.liftF(Data_Function.flip(Navigate.create)(Data_Unit.unit)($8)));
  });
...
(function(exports) {
  ...
  var component = (function () {
      var render = function (n) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("The answer is " + Data_Show.show(Data_Show.showInt)(n)) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(GotoHome.create)) ])([ Halogen_HTML_Core.text("Go to home") ]) ]);
      };
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Example.Component.Details line 44, column 3 - line 44, column 59: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var component = (function () {
      var render = function (v) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("This is home") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(GotoDetails.create)) ])([ Halogen_HTML_Core.text("Go to details") ]) ]);
      };
      var $$eval = function (v) {
...
(function(exports) {
  ...
  var main = (function () {
      ...
      return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(FRP_Event.create))(function (v1) {
              var router$prime = Halogen_Component.hoist(Halogen_HTML_Core.bifunctorHTML)(Control_Monad_Aff.functorAff)(Example_Control_Monad.runExample(42)(v1.push))(Example_Component_Router.component);
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(router$prime)(Data_Unit.unit)(v))(function (v2) {
                  return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(FRP_Event.subscribe(v1.event)(handler(v2)));
              });
          });
      }));
  })();
