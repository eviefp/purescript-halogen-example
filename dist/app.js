...
(function(exports) {
  ...
  var Example_EffectType = PS["Example.EffectType"];
...
(function(exports) {
  ...
  var getGreetingImpl = function (v) {
      ...
      throw new Error("Failed pattern match at Example.Server.ServerAPI line 21, column 1 - line 21, column 74: " + [ v.constructor.name ]);
  };
...
(function(exports) {
  ...
  var ModifyState = (function () {
      function ModifyState(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ModifyState.create = function (value0) {
          return function (value1) {
              return new ModifyState(value0, value1);
          };
      };
      return ModifyState;
  })();
  ...
  var Aff = (function () {
      ...
      Aff.create = function (value0) {
          return new Aff(value0);
      };
      return Aff;
  })();
  var Ask = (function () {
      ...
      Ask.create = function (value0) {
          return new Ask(value0);
      };
      return Ask;
  })();
              ...
              return function (token) {
                  var go = (function () {
                      var runAction = function (a) {
                          var $5 = {};
                          for (var $6 in a) {
                              if ({}.hasOwnProperty.call(a, $6)) {
                                  $5[$6] = a[$6];
                              };
                          };
                          $5.action = Control_Monad_Free.foldFree(Control_Monad_Aff.monadRecAff)(go)(unExampleM(a.action));
                          return $5;
                      };
                      var runOptions = function (d) {
                          var $8 = {};
                          for (var $9 in d) {
                              if ({}.hasOwnProperty.call(d, $9)) {
                                  $8[$9] = d[$9];
                              };
                          };
                          $8.actions = Data_Functor.map(Data_Functor.functorArray)(runAction)(d.actions);
                          return $8;
                      };
                      return function (v) {
                          if (v instanceof Aff) {
                          ...
                          if (v instanceof Navigate) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(push(PushRoute.create(v.value0))))(function () {
                          ...
                          if (v instanceof State) {
                              ...
                              throw new Error("Failed pattern match at Example.Control.Monad line 136, column 7 - line 140, column 45: " + [ v.value0.constructor.name ]);
                          };
                          if (v instanceof ServerAPI) {
                              return v.value0(token);
                          };
                          if (v instanceof ShowDialog) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(push(PushShowDialog.create(runOptions(v.value0)))))(function () {
                                  return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(v.value1);
                              });
                          };
                          throw new Error("Failed pattern match at Example.Control.Monad line 128, column 9 - line 145, column 13: " + [ v.constructor.name ]);
                      };
                  })();
                  return function ($24) {
                      return Control_Monad_Free.foldFree(Control_Monad_Aff.monadRecAff)(go)(unExampleM($24));
                  };
              };
          };
      };
  ...
  var navigationDSLAlerterM = new Example_DSL_Navigation.NavigationDSL(function () {
      ...
      return ExampleM(Control_Monad_Free.liftF(Data_Function.flip(Navigate.create)(Data_Unit.unit)($25)));
  });
  var serverDSLExampleM = new Example_DSL_Server.ServerDSL(function () {
      return monadExampleM;
  }, ExampleM(Control_Monad_Free.liftF(ServerAPI.create(Example_Server_ServerAPI.getGreetingImpl))));
  var stateDSLExampleM = new Example_DSL_State.StateDSL(function () {
      return monadExampleM;
  }, ExampleM(Control_Monad_Free.liftF(State.create(GetState.create(Control_Category.id(Control_Category.categoryFn))))), function ($26) {
      return ExampleM(Control_Monad_Free.liftF(State.create(Data_Function.flip(ModifyState.create)(Control_Category.id(Control_Category.categoryFn))($26))));
  });
  var monadEffAlerterM = new Control_Monad_Eff_Class.MonadEff(function () {
      return monadExampleM;
  }, function ($27) {
      return ExampleM(Control_Monad_Free.liftF(Aff.create(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)($27))));
  });
  var monadAskAlerterM = new Control_Monad_Reader_Class.MonadAsk(function () {
      return monadExampleM;
  }, ExampleM(Control_Monad_Free.liftF(Ask.create(Control_Category.id(Control_Category.categoryFn)))));
  var monadAffAlerterM = new Control_Monad_Aff_Class.MonadAff(function () {
      return monadEffAlerterM;
  }, function ($28) {
      return ExampleM(Control_Monad_Free.liftF(Aff.create($28)));
  });                                                  
  var dialogDSLAlerterM = new Example_DSL_Dialog.DialogDSL(function () {
      return monadExampleM;
  }, function ($29) {
      return ExampleM(Control_Monad_Free.liftF(Data_Function.flip(ShowDialog.create)(Data_Unit.unit)($29)));
  });                                              
  var applicativeExampleM = Control_Monad_Free.freeApplicative;
  exports["Aff"] = Aff;
  exports["Ask"] = Ask;
  exports["Navigate"] = Navigate;
  exports["State"] = State;
  ...
  exports["monadEffAlerterM"] = monadEffAlerterM;
  exports["monadAffAlerterM"] = monadAffAlerterM;
  ...
  exports["dialogDSLAlerterM"] = dialogDSLAlerterM;
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          if (v instanceof Initialize) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Reader_Class.ask(Halogen_Query_HalogenM.monadAskHalogenM(Example_Control_Monad.monadAskAlerterM)))(function (v1) {
          ...
          if (v instanceof ValueChanged) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  ...
                  $9.secret = Data_Maybe.maybe(st.secret)(Control_Category.id(Control_Category.categoryFn))(num);
                  return $9;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          ...
          if (v instanceof UpdateValue) {
              var updateValue = Example_DSL_State.setState(Example_Control_Monad.stateDSLExampleM);
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Example_DSL_Dialog.showDialog(Example_DSL_Dialog.dialogDSLHalogenM(Example_Control_Monad.dialogDSLAlerterM))({
                      title: "Confirmation", 
          ...
          if (v instanceof GotoHome) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Example_DSL_Navigation.navigate(Example_DSL_Navigation.navigationDSLHalogenM(Example_Control_Monad.navigationDSLAlerterM))(Example_Component_Router_Query.Home.value))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          throw new Error("Failed pattern match at Example.Component.Details line 66, column 3 - line 66, column 59: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var component = (function () {
      var render = function (st) {
          var showSecretNumber = function (v) {
              ...
              throw new Error("Failed pattern match at Example.Component.Home line 56, column 5 - line 56, column 44: " + [ v.constructor.name ]);
          };
  ...
  var $$eval = function (v) {
          ...
          if (v instanceof GotoDetails) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Example_DSL_Navigation.navigate(Example_DSL_Navigation.navigationDSLHalogenM(Example_Control_Monad.navigationDSLAlerterM))(Example_Component_Router_Query.Details.value))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          throw new Error("Failed pattern match at Example.Component.Home line 62, column 3 - line 62, column 59: " + [ v.constructor.name ]);
      };
      return Halogen_Component.lifecycleComponent(Halogen_HTML_Core.bifunctorHTML)({
          initialState: Data_Function["const"]({
  ...
  var component = (function () {
      var render = function (v) {
          var renderRoute = function (v1) {
              ...
              throw new Error("Failed pattern match at Example.Component.Router line 62, column 19 - line 64, column 68: " + [ v1.constructor.name ]);
          };
          ...
          var renderDialog = function (v1) {
              ...
              throw new Error("Failed pattern match at Example.Component.Router line 66, column 5 - line 66, column 90: " + [ v1.constructor.name ]);
          };
      ...
      var $$eval = function (v) {
                      ...
                      if (v1.dialogOptions instanceof Data_Maybe.Just) {
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                              ...
                              if (maybeAction instanceof Data_Maybe.Just) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Example_Control_Monad.monadAffAlerterM))(maybeAction.value0.action))(function () {
                              ...
                              throw new Error("Failed pattern match at Example.Component.Router line 86, column 9 - line 91, column 22: " + [ maybeAction.constructor.name ]);
                          })())(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                          });
                      };
                      throw new Error("Failed pattern match at Example.Component.Router line 82, column 5 - line 92, column 18: " + [ v1.dialogOptions.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              });
          ...
          throw new Error("Failed pattern match at Example.Component.Router line 76, column 3 - line 76, column 75: " + [ v.constructor.name ]);
      };
              ...
              return function __do() {
                  (function () {
                      if (pt instanceof Example_Control_Monad.PushRoute) {
                          return function __do() {
                              var v = Control_Monad_Aff.launchAff(driver.query(Halogen_Query.action(Example_Component_Router_Query.Goto.create(pt.value0))))();
                              return Data_Unit.unit;
                          };
                      };
                      if (pt instanceof Example_Control_Monad.PushShowDialog) {
                          return function __do() {
                              var v = Control_Monad_Aff.launchAff(driver.query(Halogen_Query.action(Example_Component_Router_Query.ShowDialog.create(pt.value0))))();
                              return Data_Unit.unit;
                          };
                      };
                      throw new Error("Failed pattern match at Main line 55, column 5 - line 61, column 18: " + [ pt.constructor.name ]);
                  })()();
                  return Data_Unit.unit;
              };
          };
