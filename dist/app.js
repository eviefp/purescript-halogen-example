...
(function(exports) {
  ...
  var component = (function () {
      var render = function (n) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("The answer is " + Data_Show.show(Data_Show.showInt)(n)) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Change secret number: "), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputNumber.value), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(UpdateValue.create)) ]) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(GotoHome.create)) ])([ Halogen_HTML_Core.text("Go to home") ]) ]);
      };
      var $$eval = function (v) {
          ...
          if (v instanceof UpdateValue) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Example_DSL_State.modifyState(Example_DSL_State.stateDSLHalogenM(Example_Control_Monad.stateDSLExampleM))(function (n) {
                  return Data_Maybe.maybe(n)(Control_Category.id(Control_Category.categoryFn))(num);
              }))(function () {
          ...
          throw new Error("Failed pattern match at Example.Component.Details line 55, column 3 - line 55, column 59: " + [ v.constructor.name ]);
      };
      return Halogen_Component.lifecycleComponent(Halogen_HTML_Core.bifunctorHTML)({
          initialState: Data_Function["const"](1), 
          render: render, 
          "eval": $$eval, 
  ...
  var component = (function () {
      var render = (function () {
          var renderRoute = function (v) {
              if (v instanceof Example_Component_Router_Query.Home) {
                  return Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Example_Component_Home.component)(Data_Unit.unit)(Data_Void.absurd);
              };
              if (v instanceof Example_Component_Router_Query.Details) {
                  return Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(Example_Component_Details.component)(Data_Unit.unit)(Data_Void.absurd);
              };
              throw new Error("Failed pattern match at Example.Component.Router line 45, column 19 - line 47, column 68: " + [ v.constructor.name ]);
          };
          return renderRoute;
      })();
      var $$eval = function (v) {
      ...
      return Halogen_Component.parentComponent(Data_Either.ordEither(Data_Ord.ordUnit)(Data_Either.ordEither(Data_Ord.ordUnit)(Data_Ord.ordVoid)))({
          initialState: Data_Function["const"](Example_Component_Router_Query.Home.value), 
          render: render, 
          "eval": $$eval, 
          receiver: Data_Function["const"](Data_Maybe.Nothing.value)
      });
  ...
  var main = (function () {
      var handler = function (driver) {
          return function (route) {
              return function __do() {
                  var v = Control_Monad_Aff.launchAff(driver.query(Halogen_Query.action(Example_Component_Router_Query.Goto.create(route))))();
